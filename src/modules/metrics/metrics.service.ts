...
/**
 * Prometheus exposition for ElementKore-Wa. Kept dependency-free (no prom-client) — the
...
export class MetricsService {
  ...
  async render(): Promise<string> {
    ...
    gauge('openwa_up', 'Whether the ElementKore-Wa process is up (always 1 when scraped).', 1);
