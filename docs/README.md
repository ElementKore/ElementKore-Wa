...
<h1 align="center">ElementKore-Wa Documentation</h1>
<p align="center">
...
| 22  | [n8n Integration](./22-n8n-integration.md)                               | n8n community nodes for ElementKore-Wa                                             |
| 23  | [Community Integrations](./23-community-integrations.md)                 | Third-party adapters built on the ElementKore-Wa API                               |
...
| [Webhook Signature Verification](./examples/webhook-signature-verification.md) | Verify signed ElementKore-Wa webhook deliveries in Node.js and Python    |
| [n8n Appointment Booking Workflow](./examples/n8n-appointment-booking.md)      | Build an appointment-booking flow with ElementKore-Wa and n8n            |
...
ElementKore-Wa seeds a default API key on first run and writes it to:
...
_ElementKore-Wa Documentation · Last updated: 2026-07-28_
